...
// Constants
const COIN_SIZE = 10_000000 * (10 ** 9); // The size of a splitted E4C coin
const E4C_COIN_TYPE = `0x2::coin::Coin<${E4C_PACKAGE}::e4c::E4C>`;

console.log("Admin Address: ",ADMIN_PHRASE, PLAYER_PHRASE);
...
const objectId ="0xb29ad46683e984e59cc1abe083580fbc56f0da6c89f9266ba3c777e046049d95"
    // getting all objects of type E4C 
    // const userObjects = await client.getObject({
    //     id: objectId,
    //     options: {
    //       showContent: true,
    //       showType: true,
    //     },
    // })
    const E4CObjects = await client.getObject({
        id: objectId,
        options: {
          showContent: true,
          showType: true,
    ...
    const e4cCoin = E4CObjects.data?.objectId as string;
...
const topUpGamingPool = async () => {
    ...
    // });
    const objectId ="0x2f7a4cffd09f65f0fec38d7b73df03ea9bc7c5d498a3a0bcea749eeca3936830"
